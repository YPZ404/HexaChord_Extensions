...
//			System.out.println("Voici le coef : "+1/SimplicialTonnetz.getZ12HexaTonnetz_compliance_coef(SimplicialTonnetz.getZ12HexaTonnetzList().get(i)));
			// Compliance corrigée, on multiplie toutes les moyennes par le coef qui fait que l'aléatoire tend vers1. Puis on retire 1 pour avoir la diff par rapport à l'aléatoire.
			...
			// Compliance corrigée, on se contente de retirer sa valeur moyenne à caque myenne de compliance. (On ne normalise pas pour les rendre tous équitables)
