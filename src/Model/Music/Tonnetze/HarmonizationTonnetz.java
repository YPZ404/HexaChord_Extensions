...
//			}			
	...
	public float get_compliance(HarmonizationTonnetz harmo_tonnetz){
		...
		// Si aucune plaque n'est à 0, alors on définit la compliance comme le produit VC1*HC*VC2
		// Chaque VC est pris 2 fois en compte car on considère un accord une fois dans le contexte de son passé
...
//		// compliance de la plaque comme produit des 4 compliances : inconvénient : si une compliance 
//		// verticale est nulle la compliance de la plaque est nulle
//		//return vc1*vc2*hc1*hc2;
//		// 2ème méthode : on fait la moyenne des 4 compliances : inconvénient : on ne prend plus en compte
//		// les 2-compliances verticales >0 (seules les arrètes verticales comptent)
//		// 3ème méthode : produit vc1*hc*vc2
