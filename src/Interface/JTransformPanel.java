...
public class JTransformPanel extends JComponent implements MouseInputListener, MouseWheelListener,  KeyListener, ComponentListener {
    ...
    public static boolean _isMirrored = false;             // Boolean to check if the grid is mirrored or not
...
//    }
    ...
    public void rotateAfterButton()
    {


        _rot.set_angle((float)Math.PI/2);
        _trans.rotate((float)Math.PI/2);
        on_transformation();
